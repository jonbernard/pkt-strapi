...
export interface ApiMemberMember extends Schema.CollectionType {
  ...
  attributes: {
    prefix: Attribute.Enumeration<['Mr', 'Master', 'Miss', 'Mrs', 'Ms', 'Mx']>;
    firstName: Attribute.String;
    ...
    email: Attribute.Email;
    altEmail: Attribute.Email;
    phone: Attribute.String;
    altPhone: Attribute.String;
    major: Attribute.String;
    occupationTitle: Attribute.String;
    occupationEmployer: Attribute.String;
    usService: Attribute.String;
    lost: Attribute.Boolean & Attribute.DefaultTo<false>;
    dead: Attribute.Boolean & Attribute.DefaultTo<false>;
    deathDate: Attribute.Date;
    obitUrl: Attribute.String;
    hrog: Attribute.Boolean & Attribute.DefaultTo<false>;
    hrogDate: Attribute.Date;
    nhqId: Attribute.String;
    initiation: Attribute.Date;
    pin: Attribute.String;
    notes: Attribute.Text;
    spouse: Attribute.String;
    children: Attribute.String;
    littleBrothers: Attribute.Relation<
      'api::member.member',
      'oneToMany',
      'api::member.member'
    >;
    bigBrother: Attribute.Relation<
      'api::member.member',
      'manyToOne',
      'api::member.member'
    >;
