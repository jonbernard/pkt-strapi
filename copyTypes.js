...
const destinationFolder = "nextjs/src/types";

const files = [
  {
    src: path.join(__dirname, "./strapi/generated/contentTypes.d.ts"),
    dest: path.join(__dirname, `./${destinationFolder}/contentTypes.d.ts`),
  },
  {
    src: path.join(__dirname, "./strapi/generated/components.d.ts"),
